...
*** coffee-mode
    ...
    confused by =coffee-mode= at first. It brings a neat approach for
    "what should happen when you press TAB," but I was thrown off by
    the size of the indents. At first it was defaulting to 8 spaces
    when I wanted 2.
