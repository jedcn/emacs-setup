...
(defvar my-packages '(starter-kit starter-kit-lisp yasnippet rvm rspec-mode dired-details dired-details+ markdown-mode ace-jump-mode yaml-mode haml-mode feature-mode)
